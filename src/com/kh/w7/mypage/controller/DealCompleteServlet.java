...
public class DealCompleteServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//전체 게시글 수 조회
		int listCount = ms.getcomListCount(loginCode);
		//총 페이지 수 계산
		...
		ArrayList<MyPage>deallist = new MypageService().selectDealList(loginCode,currentPage, limit);
		
		HashMap<String, Object> result = new HashMap<>();
		result.put("dlist", deallist);
