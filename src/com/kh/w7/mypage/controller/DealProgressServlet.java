...
@WebServlet("/selectList.progress")
public class DealProgressServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public DealProgressServlet() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//전체 게시글 수 조회
		int listCount = ms.getprogressListCount(loginCode);
		//총 페이지 수 계산
		...
		ArrayList<MyPage>progresslist = new MypageService().selectdealprogressList(loginCode, currentPage, limit);
