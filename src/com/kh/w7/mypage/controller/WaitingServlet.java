...
public class WaitingServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//전체 게시글 수 조회
		int listCount = ms.getwaitListCount(loginCode);
		//총 페이지 수 계산
		...
		ArrayList<MyPage>waitlist = new MypageService().selectWaitingList(loginCode,currentPage,limit);
		
		HashMap<String, Object> result = new HashMap<>();
		result.put("wlist", waitlist);
