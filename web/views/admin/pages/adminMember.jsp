			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav" id="side-menu">
						<li><a href="tables1.html"><i class="fa fa-table fa-fw"></i>
								회원관리</a></li>

						<li><a href="tables2.html"><i class="fa fa-table fa-fw"></i>
								환불관리</a></li>

						<li><a href="tables3.html"><i class="fa fa-table fa-fw"></i>
								고객센터</a></li>
