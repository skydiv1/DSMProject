...
<body>
	...
	<header class="masthead"
		style="background-image: url('../../img/drone_background.jpg'); background-size: 100% 500px; margin-top: 0px; background-position:center;">
	<div class="container">
		<div class="intro-text" style="padding-top: 35px;">
			...
			<a class="btn btn-primary btn-xl text-uppercase js-scroll-trigger"
				href="#" style="padding: 7px 60px; box-shadow: 0px 0px 10px #000;"><label
				style="width: 100px; height: 10px;">로그인</label></a>
