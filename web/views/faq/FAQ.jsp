...
<body>
	...
	<div class="container">
		<div id="faq" data-obj-id="FAQ" data-obj-type="element"
		...
		<div>
			<table class="table table-striped"
				...
				<thead>
					<tr>
						<th
							style="width: 6%; background-color: #eeeeee; text-align: center;">분류</th>
						<th
			...
			<ul class="pagination">
				...
				<div class="input-group-prepend" id="searchText"
					...
					<button class="btn btn-outline-secondary dropdown-toggle"
						...
						aria-expanded="false">상품</button>
					<input type="text" placeholder="검색어 입력">
					<button>검색</button>
					<div class="dropdown-menu">
						<a class="dropdown-item" href="#">상품</a> <a class="dropdown-item"
							href="#">결제</a> <a class="dropdown-item" href="#">회원</a> <a
							class="dropdown-item" href="#">신고</a>
					</div>
				</div>
