          ...
          <table class="table table-hover">
			  ...
			  <tbody>
			    <tr>
			      ...
			      <td class="td1">@mdo</td>
			      <td style="width: 10px; padding-right: 0px"><button type="button" class="btn btn-warning" onclick = "location.href = '<%= request.getContextPath()%>/selectOneProduct.de?memberCode=<%= loginUser.getMemberCode()%>&productNo=<%= 2%>'">결제하기</button></td>
